...
const AdminServiceDetailScreen = ({ route, customer: propCustomer, shopId: propShopId, onBack }) => {
    ...
    const loadData = async (showLoading = true) => {
        ...
        try {
            const response = await serviceAPI.getById(shopId, initialCustomer.id);
            ...
            console.error('Failed to load admin service details:', error);
        } finally {
        ...
        return (
            <View style={styles.card}>
                <View style={styles.cardHeaderRow}>
                    ...
                    <Text style={styles.cardTitle}>Service Log & Earnings</Text>
                </View>
            ...
            <View style={{ flex: 1 }}>
                ...
                >
                    <View style={styles.headerContent}>
                        ...
                        <View>
                            <Text style={styles.headerTitle}>Service logs for {customer?.name}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.card}>
                        <View style={styles.cardHeaderRow}>
                            ...
                            <Text style={styles.cardTitle}>Service Provider Information</Text>
                        </View>
